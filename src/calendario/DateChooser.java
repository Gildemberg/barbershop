...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new calendario.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new calendario.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new calendario.Button();
        cmdPrevious = new calendario.Button();
        slide = new calendario.Slider();

        setBackground(new java.awt.Color(255, 255, 255));
        setPreferredSize(new java.awt.Dimension(723, 370));
        ...
        lb.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        ...
        slide.setForeground(new java.awt.Color(0, 51, 102));
            ...
            .addGroup(headerLayout.createSequentialGroup()
                ...
                .addGroup(headerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(headerLayout.createSequentialGroup()
                        ...
                        .addComponent(MY, javax.swing.GroupLayout.DEFAULT_SIZE, 546, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private calendario.Button cmdForward;
    private calendario.Button cmdMonth;
    private calendario.Button cmdPrevious;
    private calendario.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private calendario.Slider slide;
